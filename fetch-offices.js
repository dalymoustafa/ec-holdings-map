...
function extractCity(address) {
  ...
  for (let i = parts.length - 2; i >= 0; i--) {
    ...
    if (/^\d+$/.test(part)) continue;
    if (/\b(street|road|avenue|boulevard|floor|level|suite|tower|plaza|bldg|place|district|avenida|rua|heights|zayed|hotel|highway|ward|center|centre|financial|building|drive|quay|collyer)\b/i.test(part)) continue;
...
<head>
  ...
  <title>EC Holdings — Office Locations</title>
